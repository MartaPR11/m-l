...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>admin" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/marvelstudios.jpg" alt="LOGO DE MARVEL">
        </a>
        ...
        <?php if (isset($_SESSION['usuario'])){ ?>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <?php if ($_SESSION['personajes'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/personajes" title="Personajes">Personajes</a>
                    </li>
                <?php } ?>
