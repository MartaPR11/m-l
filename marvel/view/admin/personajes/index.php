<h3>
    <a href="<?php echo $_SESSION['home'] ?>admin" title="Inicio">Inicio</a> <span>| Personajes</span>
</h3>
<div class="row">
    <!--Nuevo-->
        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/personajes/crear" ?>" title="Añadir nuevo personaje">
        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/personajes/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/personajes/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/personajes/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    ...
                    <a href="<?php echo $_SESSION['home']."admin/personajes/borrar/".$row->id ?>" title="Borrar">
